...
APP_NAME := lfx-v2-forwards-service/forwards-service
...
HELM_CHART_PATH := ./charts/lfx-v2-forwards-service
HELM_RELEASE_NAME := lfx-v2-forwards-service
HELM_NAMESPACE := lfx
...
build:
	go build \
		...
		-o bin/$(APP_NAME) ./cmd/forwards-api
